                ...
                <div class="row g-4 mt-4">
                    ...
                    <div class="col-md-6">
                        <div class="info-card">
                            ...
                            <div class="info-item">
                                <label>Status</label>
                                <p><span class="<?= $userStatusBadgeClass ?>"><i class="<?= $statusIcon ?>"></i><?= htmlspecialchars(ucfirst($user['status'])); ?></span></p>
                            </div>
                ...
                <div class="text-center mt-5">
                    <div class="d-flex justify-content-center align-items-center gap-2">
                        <?php if ($user['user_id'] == $_SESSION['user_id']): ?>
                            <a href="updatesupplierprofile.php?user_id=<?= urlencode($user['user_id']) ?>" class="btn btn-outline-primary"><i class="fa-solid fa-pen-to-square me-2"></i>Update Profile</a>
                        <?php endif; ?>
                        <a href="supplierdashboard.php" class="btn btn-success"><i class="fa-solid fa-arrow-left me-2"></i>Return</a>
                    </div>
                </div>
            </div>
        </div>

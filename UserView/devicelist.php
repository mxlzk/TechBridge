...
if (isset($_POST['add_to_cart']) && isset($_SESSION['user_id'])) {
    ...
    // If device is already in cart, update the quantity
    if ($existing) {
        // Update the quantity
        ...
        // Insert the device into the cart
        ...
        <div class="container py-4">
            ...
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center">
                <div class="d-flex flex-column">
                    <h2 class="store-title"><i class="fa-solid fa-list me-2"></i>Device List</h2>
                    <p class="store-subtitle"><i class="fa-solid fa-circle-info me-2"></i>Discover available technological devices/gadgets with affordable prices.</p>
                </div>

                <form class="d-flex ms-auto me-3" action="devicelist.php" method="GET" id="searchForm">
                                    ...
                                    <div class="mt-auto">
                                        ...
                                        <form action="devicelist.php" method="POST">
                                            <div class="device-actions mt-auto">
                                                ...
                                                <!-- Action Buttons -->
                                                <div class="mb-2 mt-4">
                                                    <a href="viewdevice.php?device_id=<?= $row['device_id']; ?>" class="btn btn-outline-primary w-100"><i class="fa-solid fa-eye me-2"></i>View Device Details</a>
                                                    <button type="submit" name="add_to_cart" class="<?= $isUnavailable ? 'btn btn-danger' : 'btn btn-success'; ?> w-100 mt-2" <?= $isUnavailable ? 'disabled' : '' ?>>
                                                    <?php if($isUnavailable): ?>

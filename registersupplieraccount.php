...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    { 
        ...
        header('Location: registersupplieraccount.php');
        exit(); 
    } 
    ...
    if ($stmt->execute()) { 
        ...
        $_SESSION['error'] = "Unable to create supplier account.";
    }
...
<head>
    ...
    <title>Register Supplier Account</title>
...
<body>
    <div class="register-card">
        ...
        <div class="text-center mb-4">
            <h2 class="register-title"><i class="fa-solid fa-user-plus me-2"></i>Register Supplier Account</h2>
            <p class="register-subtitle"><i class="fa-solid fa-info-circle me-2"></i>Sign up to get started with TechBridge</p>
        </div>

        <form action="registersupplieraccount.php" method="POST">
            <div class="mb-4">

...
if (isset($_POST['update_profile'])) {
    ...
    if (isset($_FILES['profile_image']) && $_FILES['profile_image']['error'] === UPLOAD_ERR_OK) {
        ...
        if (!empty($admin['profile_image'])) {
            $oldImage = __DIR__ . '/../profileimages/' . $admin['profile_image'];
        ...
        if(move_uploaded_file($_FILES['profile_image']['tmp_name'],$targetFile)){
            ...
            if($stmt->execute()) {
                ...
                $_SESSION["success"] = "Profile image for {$admin['username']} updated successfully";
            } else {
                $_SESSION["error"] = "Failed to update profile image for {$admin['username']}";
            }
        }else{
    ...
    <div class="content">
        <div class="container py-4">
            ...
            <div class="mb-4">
                ...
                <p class="text-muted"><i class="fa-solid fa-user-shield me-2"></i>Manage your administrator credentials securely</p>
            </div>
                    ...
                    <div class="card shadow-sm border-0 rounded-4 h-100">
                        <div class="card-body">
                            <div class="text-center mb-4">
                                <form action="updateadminprofile.php" method="POST" enctype="multipart/form-data">
                                    <div class="profile-avatar" id="profilePreview">
                                        <?php if (!empty($admin['profile_image'])): ?>
                                            <img id="profilePreviewImage" src="<?= BASE_URL ?>/profileimages/<?= htmlspecialchars($admin['profile_image']); ?>" alt="Profile Picture">
                                        <?php else: ?>
                                            <span id="profileInitial"><?= strtoupper(substr($admin['username'], 0, 1)); ?></span>
                                        <?php endif; ?>
                                    </div>

                                    <h4 class="mt-3 fw-bold"><i class="fa-solid fa-user-shield me-2"></i><?= htmlspecialchars($admin['username']); ?></h4>
                            ...
                            <div class="mb-3">
                                ...
                                <span><?= htmlspecialchars(ucfirst($admin['role'])); ?></span>
                            </div>

                            <div class="alert alert-light border mt-4">
                                <h6 class="fw-bold"><i class="fa-solid fa-user-shield me-2"></i>Security Notice</h6>
                                <p class="mb-0 text-muted small">Updating your password immediately updates your administrator account's credentials. Never share your password with anyone.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            <form action="updateadminprofile.php" method="POST">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group mt-2">
                                        ...
                                        <div class="password-wrapper">
                                            <input type="password" class="form-control" placeholder="Enter old password" id="old_password" autocomplete="current-password" name="old_password" value="<?= htmlspecialchars($admin['password']); ?>" required>
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-2 mt-4">
                                    <button type="submit" class="btn btn-outline-primary" name="update_password"><i class="fa-solid fa-floppy-disk me-2"></i>Change Password</button>
                                    <a href="adminprofileview.php" class="btn btn-outline-secondary"><i class="fa-solid fa-arrow-left me-2"></i>Return</a>
                                </div>
                            </form>
                        </div>
                    </div>
